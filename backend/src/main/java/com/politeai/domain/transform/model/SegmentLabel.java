...
public enum SegmentLabel {
    ...
    ACCOUNTABILITY, SELF_JUSTIFICATION, NEGATIVE_FEEDBACK, EMOTIONAL, EXCESS_DETAIL,
    ...
    public Tier tier() {
        return switch (this) {
            ...
            case ACCOUNTABILITY, SELF_JUSTIFICATION, NEGATIVE_FEEDBACK, EMOTIONAL, EXCESS_DETAIL -> Tier.YELLOW;
