...
export default function LoginPage() {
  ...
  return (
    <Layout>
      <title>로그인 - Politely</title>
      <meta name="description" content="Politely 계정에 로그인하세요. 한국어 말투 다듬기 서비스를 이용할 수 있습니다." />
      <link rel="canonical" href="https://politely-ai.com/login" />
