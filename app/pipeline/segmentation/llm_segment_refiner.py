...
SYSTEM_PROMPT = (
    ...
    "6. 불완전 문장 분리 금지: 연결어미(~라기보단, ~보단, ~해서, ~이라서, ~하게, ~인데, ~거든, ~니까)로 "
    "끝나는 조각을 만들지 마세요. 뒤 절과 함께 하나의 단위로 유지하세요\n\n"
    "예시:\n"
    "입력: [1] 클라이언트 미팅 일정 확인했습니다 관련 자료는 내일까지 준비해서 공유드리겠습니다\n"
    "출력: [1] 클라이언트 미팅 일정 확인했습니다 ||| 관련 자료는 내일까지 준비해서 공유드리겠습니다\n\n"
    "입력: [1] 사실 제 잘못도 있지만 디자인팀에서 자료를 너무 늦게 줘서요\n"
    "출력: [1] 사실 제 잘못도 있지만 디자인팀에서 자료를 너무 늦게 줘서요\n\n"
    "입력: [1] {{DATE_1}}까지 보고서 제출 및 관련 파일 첨부 부탁드립니다\n"
    "출력: [1] {{DATE_1}}까지 보고서 제출 및 관련 파일 첨부 부탁드립니다"
)
